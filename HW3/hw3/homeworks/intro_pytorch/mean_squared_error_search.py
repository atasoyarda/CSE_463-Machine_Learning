...
@problem.tag("hw3-A", start_line=24)
def main():
    """
    ...
    for model_name, history in mse_configs.items():
        ...
        plt.plot(history["val"], label=f"{model_name}/Validation")
    plt.title(model_name)
    plt.ylim([0, 1])
    plt.legend()
    plt.xlabel("Loss")
    plt.xlabel("Epochs")
    plt.title("MSE Search")
    plt.show()

    # TODO: Get best configs

    # TODO: Print best model and its validation error
